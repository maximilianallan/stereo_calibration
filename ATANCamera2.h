...
class ATANCamera{
 public:
  ...
  void RefreshParams();
  void RefreshCvParams();
  void SetParametersToRectified();
  ...
  Vector<3> RectifiedUnProjectToWorld(const Vector<2> imPoint, float disparity);
  Vector<3> RectifiedUnProjectToWorld(const CVD::ImageRef imPoint, float disparity);
  ...
  inline double getStereoBaseline(){
    return sqrt(cvmGet(cvT,0,0)*cvmGet(cvT,0,0));
  }
  ...
  //openCV getters
  CvMat *getCvCameraMatrix();
  CvMat *getCvR();
  CvMat *getCvT();
  CvMat *getCvRectifyRotate();
  CvMat *getCvRectifyProject();
  CvMat *getCvRectifyReProject();
  cv::Mat *getMap1();
  cv::Mat *getMap2();
  CvMat *getCvDistortion();
  ...
  static const Vector<9> mvDefaultRectifyRotate;
  static const Vector<12> mvDefaultRectifyProject;
  static const Vector<16> mvDefaultRectifyReProject;
  static const Vector<9> mvDefaultcvCameraMatrix;
  static const Vector<8> mvDefaultcvDistortion;
  static const Vector<4> mvDefaultcvRectangle;
protected:
  //the Gvars
  GVars3::gvar3<Vector<8> >mgvvCvDistortion;
  GVars3::gvar3<Vector<NUMTRACKERCAMPARAMETERS> > mgvvCameraParams; 
  GVars3::gvar3<Vector<6> >mgvvSE3Parameters_Vector;
  GVars3::gvar3<Vector<9> >mgvvRectifyRotate;
  GVars3::gvar3<Vector<12> >mgvvRectifyProject;
  GVars3::gvar3<Vector<16> >mgvvRectifyReProject;
  GVars3::gvar3<Vector<9> >mgvvCVCameraMatrix;
  GVars3::gvar3<Vector<4> >mgvvCvRectangle;
  ...
  void UpdateCvParams(const CvMat&, const CvMat&, const CvMat&);
  void setcvMatrixToIntrinsic();
  ...
  CvMat *cvDistortion;
  CvMat *cvCameraMatrix;
  CvMat *cvR;
  CvMat *cvT;
  CvMat *cvRectifyRotate;
  CvMat *cvRectifyProject;
  CvMat *cvRectifyReProject;
  cv::Mat *map1;
  cv::Mat *map2;
  CvRect *cvRectangle;
